...
class Ui_KeyboardConfigDialog(object):
    ...
    def retranslateUi(self, KeyboardConfigDialog):
        ...
        self.TiltForwardComboBox.setItemText(5, _translate("KeyboardConfigDialog", "Z"))
        self.TiltForwardComboBox.setItemText(6, _translate("KeyboardConfigDialog", "X"))
        self.TiltForwardComboBox.setItemText(7, _translate("KeyboardConfigDialog", "C"))
        self.TiltForwardComboBox.setItemText(8, _translate("KeyboardConfigDialog", "Пробел"))
        self.TiltForwardComboBox.setItemText(9, _translate("KeyboardConfigDialog", "Shift"))
        self.TiltForwardComboBox.setItemText(10, _translate("KeyboardConfigDialog", "ЛКМ"))
        self.TiltForwardComboBox.setItemText(11, _translate("KeyboardConfigDialog", "ПКМ"))
        self.TiltForwardComboBox.setItemText(12, _translate("KeyboardConfigDialog", "Колесо вниз"))
        self.TiltForwardComboBox.setItemText(13, _translate("KeyboardConfigDialog", "Колесо вверх"))
        ...
        self.TiltBackwardComboBox.setItemText(5, _translate("KeyboardConfigDialog", "Z"))
        self.TiltBackwardComboBox.setItemText(6, _translate("KeyboardConfigDialog", "X"))
        self.TiltBackwardComboBox.setItemText(7, _translate("KeyboardConfigDialog", "C"))
        self.TiltBackwardComboBox.setItemText(8, _translate("KeyboardConfigDialog", "Пробел"))
        self.TiltBackwardComboBox.setItemText(9, _translate("KeyboardConfigDialog", "Shift"))
        self.TiltBackwardComboBox.setItemText(10, _translate("KeyboardConfigDialog", "ЛКМ"))
        self.TiltBackwardComboBox.setItemText(11, _translate("KeyboardConfigDialog", "ПКМ"))
        self.TiltBackwardComboBox.setItemText(12, _translate("KeyboardConfigDialog", "Колесо вниз"))
        self.TiltBackwardComboBox.setItemText(13, _translate("KeyboardConfigDialog", "Колесо вверх"))
        ...
        self.TiltLeftComboBox.setItemText(5, _translate("KeyboardConfigDialog", "Z"))
        self.TiltLeftComboBox.setItemText(6, _translate("KeyboardConfigDialog", "X"))
        self.TiltLeftComboBox.setItemText(7, _translate("KeyboardConfigDialog", "C"))
        self.TiltLeftComboBox.setItemText(8, _translate("KeyboardConfigDialog", "Пробел"))
        self.TiltLeftComboBox.setItemText(9, _translate("KeyboardConfigDialog", "Shift"))
        self.TiltLeftComboBox.setItemText(10, _translate("KeyboardConfigDialog", "ЛКМ"))
        self.TiltLeftComboBox.setItemText(11, _translate("KeyboardConfigDialog", "ПКМ"))
        self.TiltLeftComboBox.setItemText(12, _translate("KeyboardConfigDialog", "Колесо вниз"))
        self.TiltLeftComboBox.setItemText(13, _translate("KeyboardConfigDialog", "Колесо вверх"))
        ...
        self.TiltRightComboBox.setItemText(5, _translate("KeyboardConfigDialog", "Z"))
        self.TiltRightComboBox.setItemText(6, _translate("KeyboardConfigDialog", "X"))
        self.TiltRightComboBox.setItemText(7, _translate("KeyboardConfigDialog", "C"))
        self.TiltRightComboBox.setItemText(8, _translate("KeyboardConfigDialog", "Пробел"))
        self.TiltRightComboBox.setItemText(9, _translate("KeyboardConfigDialog", "Shift"))
        self.TiltRightComboBox.setItemText(10, _translate("KeyboardConfigDialog", "ЛКМ"))
        self.TiltRightComboBox.setItemText(11, _translate("KeyboardConfigDialog", "ПКМ"))
        self.TiltRightComboBox.setItemText(12, _translate("KeyboardConfigDialog", "Колесо вниз"))
        self.TiltRightComboBox.setItemText(13, _translate("KeyboardConfigDialog", "Колесо вверх"))
        ...
        self.KeyboardGestureActionComboBox.setItemText(5, _translate("KeyboardConfigDialog", "Z"))
        self.KeyboardGestureActionComboBox.setItemText(6, _translate("KeyboardConfigDialog", "X"))
        self.KeyboardGestureActionComboBox.setItemText(7, _translate("KeyboardConfigDialog", "C"))
        self.KeyboardGestureActionComboBox.setItemText(8, _translate("KeyboardConfigDialog", "Пробел"))
        self.KeyboardGestureActionComboBox.setItemText(9, _translate("KeyboardConfigDialog", "Shift"))
        self.KeyboardGestureActionComboBox.setItemText(10, _translate("KeyboardConfigDialog", "ЛКМ"))
        self.KeyboardGestureActionComboBox.setItemText(11, _translate("KeyboardConfigDialog", "ПКМ"))
        self.KeyboardGestureActionComboBox.setItemText(12, _translate("KeyboardConfigDialog", "Колесо вниз"))
        self.KeyboardGestureActionComboBox.setItemText(13, _translate("KeyboardConfigDialog", "Колесо вверх"))
